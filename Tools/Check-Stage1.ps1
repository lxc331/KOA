...
Write-Output 'PASS: managed compilation of Assets/Scripts and Stage 1/3/4/5/6 editor tools.'
...
try {
    ...
    & $mono $assembly
    if ($LASTEXITCODE -ne 0) { throw 'Stage 1/3/4/5/6 logic regression failed.' }
}
